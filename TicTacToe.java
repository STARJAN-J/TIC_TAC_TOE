...
public class TicTacToe {
    ...
    public static void player1_turn(){        
        System.out.println("\n"+player1+" enter your choice 'x' | 'o' from place of 1 to 9");
        ...
        if (place>0 && place<10) {
            ...
            System.out.println("\n'"+player1+"' Your entry of place `"+place+"` is wrong, try to input the place between No : 1-9");
            player1_turn();
        }
    ...
    public static void player2_turn(){
        System.out.println("\n"+player2+" enter your choice 'x' | 'o' from place of 1 to 9");
        ...
        if (place>0 && place<10) {
            ...
            System.out.println("\n '"+player2+"' Your entry of place `"+place+"` is wrong, try to input the place between No : 1-9");
            player2_turn();
        }
    }
